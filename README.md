...
- JSON data in `src/data/cards.json` and `src/data/decks.json`.
- One-shot conversion helper `npm run convert` (reads `docs/starterDeck.json` and writes `generated/cards.json`/`generated/decks.json`).
...
- Baseline starter deck input: `docs/starterDeck.json`
